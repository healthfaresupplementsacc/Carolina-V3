...
describe('op v4 — html + sw', () => {
  ...
  test('sw é hf-op-v46 network-first e cacheia nav.js + ws.js + pause-ui.js + o hub de estoque', () => {
    expect(SW).toContain("'hf-op-v46'");   // bump obriga o cliente a pegar o copiloto de frete (Fase A)
