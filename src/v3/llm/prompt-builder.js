...
const SYSTEM_PROMPT = [
  ...
  '   bottles. "feito 300 até agora" → partial_count.',
  ...
  '   linha.',
  '9. Responda só com o JSON do schema abaixo.',
  '',
  ...
  '             break_end|eod_count|partial_count|note|narrative",',
